...
namespace Microsoft.OData
{
    ...
    internal sealed class ODataContextUrlInfo
    {
        ...
        {
            // In 7.4.1 and before, this code results in an incorrect context Url for section 10.9
            // of the spec when there was no $select clause.
            if (settings != null && settings.LibraryCompatibility <= ODataLibraryCompatibility.Version7_4_1)
            {
