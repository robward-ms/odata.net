...
namespace Microsoft.OData.Tests.JsonLight
{
    public class ODataJsonLightOutputContextTests
    {
        ...
        [Fact]
        public void ShouldBeAbleToWriteNullPropertyResponseWithoutModel()
        {
            ODataProperty property = new ODataProperty { Name = "Prop", Value = null };
            WriteAndValidate(outputContext => outputContext.WriteProperty(property), "{\"@odata.context\":\"http://odata.org/test/$metadata#Edm.Null\",\"value\":null}", writingResponse: true, allowNull: true);
        }
        ...
        public void ThrowsOnWriteNullPropertyResponseWithoutModel()
        {
            ...
            test.ShouldThrow<ODataException>().WithMessage(ODataErrorStrings.ODataMessageWriter_CannotWriteNullInRawFormat);
        }
        ...
        [Fact]
        public void ShouldBeAbleToWriteNullPropertyResponseWithoutModelAsync()
        {
            ODataProperty property = new ODataProperty { Name = "Prop", Value = null };
            WriteAndValidate(outputContext => outputContext.WritePropertyAsync(property).Wait(), "{\"@odata.context\":\"http://odata.org/test/$metadata#Edm.Null\",\"value\":null}", writingResponse: false, synchronous: false, allowNull: true);
        }
        ...
        public void ThrowsOnWriteNullPropertyResponseWithoutModelAsync()
        {
            ...
            test.ShouldThrow<AggregateException>().WithInnerMessage(ODataErrorStrings.ODataMessageWriter_CannotWriteNullInRawFormat);
        }
            ...
            bool use6x = false)
        {
            ...
            var outputContext = CreateJsonLightOutputContext(stream, writingResponse, synchronous, allowNull, use6x);
            test(outputContext);
            ...
            bool use6x = false)
        {
            ...
            if (allowNull)
            {
                settings.Validations &= ~ValidationKinds.ThrowOnTopLevelNullProperty;
            }
